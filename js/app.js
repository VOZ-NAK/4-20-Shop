 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    const menuMobileBtn = document.querySelectorAll(".menu-mobile__item.menu-mobile__item");
        ...
        const inputMasks = document.querySelectorAll(".input__tel");
        ...
        function initSliders() {
            ...
            if (document.querySelector(".new-brands__slider")) new core(".new-brands__slider", {
                modules: [ Pagination ],
                spaceBetween: 20,
                slidesPerView: 4,
                loop: true,
            ...
            if (document.querySelector(".slide-body-swiper-home__slider")) {
                new core(".slide-body-swiper-home__slider", {
            ...
            if (document.querySelector(".body-swiper-home__slider")) new core(".body-swiper-home__slider", {
                modules: [ Pagination ],
                spaceBetween: 30,
                slidesPerView: "auto",
                loop: true,
            ...
            if (document.querySelector(".actual__slider")) new core(".actual__slider", {
                modules: [ Pagination ],
                spaceBetween: 30,
                slidesPerView: 1,
                pagination: {
            ...
            let swiperThumbs;
            let thumbSlide;
            const thumbsSlides = document.querySelectorAll(".vertical-card__wrapper .swiper-slide");
            function addBorderToThumb(index) {
                thumbsSlides[index].classList.add("swiper-slide-hovered");
            }
            ...
            if (document.querySelector(".vertical-card__slider")) swiperThumbs = new core(".vertical-card__slider", {
                modules: [ Navigation ],
                direction: "horizontal",
                slidesPerView: "auto",
                spaceBetween: 10,
                ...
                slideToClickedSlide: false,
                navigation: {
                    nextEl: ".vertical-card__swiper-button-next",
                    prevEl: ".vertical-card__swiper-button-prev"
                },
                breakpoints: {
                    900: {
                        direction: "vertical",
            ...
            if (document.querySelector(".horizontal-card__slider")) thumbSlide = new core(".horizontal-card__slider", {
                ...
                slideToClickedSlide: false,
                navigation: {
                    nextEl: ".horizontal-card__swiper-button-prev",
                    prevEl: ".horizontal-card__swiper-button-next"
                },
                on: {
                    slideChange: function() {
                        ...
                        removeActiveBorders();
                        addBorderToThumb(activeIndex);
                    }
                }
            });
            thumbsSlides.forEach(((swiperThumbs, index) => {
                swiperThumbs.addEventListener("mouseenter", (() => {
                    thumbSlide.slideTo(index);
                }));
            }));
        }
        ...
        window.addEventListener("load", (function(e) {
            initSliders();
            resizableSwiper("(max-width: 952px)", ".news__slider", {
                modules: [ Pagination ],
                spaceBetween: 32,
                slidesPerView: 1,
                pagination: {
        ...
        const inputHeader = document.querySelector(".search-header__input");
        document.addEventListener("click", (function(e) {
            let targetElement = e.target;
            if (targetElement.classList.contains("search-header__button")) inputHeader.value = "";
        }));
        const menuItems = document.querySelectorAll(".menu__item");
        const submenuCatalog = document.querySelector(".sub-menu-catalog");
        const submenuColumn = document.querySelector(".sub-menu-catalog__column");
        const catalogContainer = document.querySelector(".sub-menu-catalog__container");
        const headerMenu = document.querySelector(".header__menu");
        const saleHeader = document.querySelector(".sale-header");
        const saleHeaderContainer = document.querySelector(".sale-header__container");
        const menuData = {
            new: {
                category: "новинки",
                items: [ {
        ...
        function createSubMenuColumn({category, items}) {
            const column = document.createElement("div");
            column.className = "sub-menu-catalog__column";
            column.innerHTML = `\n    <a href="./catalog.html" class="sub-menu-catalog__category">${category}</a>\n    <ul class="sub-menu-catalog__list">\n      ${items.map((item => `<li class="sub-menu-catalog__item">\n        <a href="./catalog.html" class="sub-menu-catalog__link" href="${item.href}">${item.name}</a>\n      </li>`)).join("")}\n    </ul>`;
            return column;
        }
        function toggleMenu(menuText) {
            if ("sale" === menuText) {
                saleHeader.classList.add("active");
                submenuCatalog.classList.remove("active");
            } else {
                saleHeader.classList.remove("active");
                submenuCatalog.classList.add("active");
                submenuColumn.innerHTML = "";
                const submenuData = menuData[menuText];
                if (submenuData) submenuColumn.appendChild(createSubMenuColumn(submenuData));
            }
        }
        menuItems.forEach((item => {
            item.addEventListener("mouseover", (() => toggleMenu(item.id)));
        }));
        document.addEventListener("mouseover", (event => {
            const {target} = event;
            const isInsideMenu = headerMenu.contains(target) || catalogContainer.contains(target) || saleHeaderContainer.contains(target);
            if (!isInsideMenu) {
                submenuCatalog.classList.remove("active");
                saleHeader.classList.remove("active");
            }
        }));
        const favoritesContainer = document.querySelector(".favorite-body");
        const sortingCatalog = document.querySelector(".sorting-catalog");
        const filtersCatalog = document.querySelector(".filters-catalog");
        const filterCtalogClose = document.querySelector(".filters-catalog__close");
        document.addEventListener("click", (function(event) {
            if (event.target.closest(".options__item_favorite")) window.location.href = "./favorite.html"; else if (event.target.closest(".options__item_user")) window.location.href = "./profile.html"; else if (event.target.closest(".options__item_cart")) window.location.href = "./cart.html";
            if (event.target.closest(".favorite__button")) favoritesContainer.innerHTML = "";
            if (event.target.closest(".quantity__increment")) {
                count++;
                updateCounter();
            }
            if (event.target.closest(".quantity__decrement") && count > 1) {
                count--;
                updateCounter();
            }
            if (event.target.closest(".head-catalog__button_sorting")) sortingCatalog.classList.toggle("sorting-catalog__active"); else if (!sortingCatalog.contains(event.target) && sortingCatalog.classList.contains("sorting-catalog__active")) sortingCatalog.classList.remove("sorting-catalog__active");
            if (event.target.closest(".head-catalog__button_filters")) {
                filtersCatalog.classList.toggle("filters-catalog_active");
                document.documentElement.classList.toggle("filters-open");
            } else if (!filtersCatalog.contains(event.target) && filtersCatalog.classList.contains("filters-catalog_active") || event.target == filterCtalogClose) {
                filtersCatalog.classList.remove("filters-catalog_active");
                document.documentElement.classList.remove("filters-open");
            }
        }));
        if (window.matchMedia("(min-width: 992px)").matches) {
            const imgs = document.querySelectorAll(".horizontal-card__image");
            imgs.forEach((img => {
                ...
                img.addEventListener("mousemove", (e => {
                    ...
                    const xPercent = pos.x / img.width * 50;
                    const yPercent = pos.y / img.height * 50;
        ...
        function updateCounter() {
            ...
            const decrementButton = document.querySelector(".quantity__decrement");
            if (count <= 1) decrementButton.classList.add("disabled"); else decrementButton.classList.remove("disabled");
        }
        let rangeMin = 100;
        ...
        rangeInput.forEach((input => {
            input.addEventListener("input", (e => {
                ...
                if (maxRange - minRange < rangeMin) if ("min" === e.target.className) rangeInput[0].value = maxRange - rangeMin; else rangeInput[1].value = minRange + rangeMin; else {
        ...
        rangePrice.forEach((input => {
            input.addEventListener("input", (e => {
                ...
                if (maxPrice - minPrice >= rangeMin && maxPrice <= rangeInput[1].max) if ("min" === e.target.className) {
        ...
        function updateCityAndMap(city, mapUrl) {
            const cityElement = document.querySelector(".info-map__city span");
            const mapIframe = document.querySelector(".chart-map__map");
            cityElement.textContent = city;
            mapIframe.src = mapUrl;
        }
        const params = getQueryParams();
        if (params.city && params.mapUrl) updateCityAndMap(params.city, params.mapUrl);
        window["FLS"] = true;
        isWebp();
        menuInit();
        spollers();
